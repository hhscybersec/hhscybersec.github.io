		...
		<div>
			...
			<div className="w-fit m-auto">
				...
				<div className='pb-8 w-4/5 sm:w-3/4 md:w-2/3 lg:w-3/4 xl:w-4/5 m-auto grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6'>
					<Officer name="Revati Tambe" position="Co-President" picture="/officers/placeholder.webp"/>
					<Officer name="Ofek Sadeh" position="Co-President" picture="/officers/placeholder.webp"/>
                    <Officer name="Evan Wescott" position="Secretary/Treasurer" picture="/officers/placeholder.webp"/>
				</div>
			</div>
		</div>
	)
